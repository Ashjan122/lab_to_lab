...
class _ClaimScreenState extends State<ClaimScreen> {
  ...
  CollectionReference<Map<String, dynamic>> get _patientsCol => FirebaseFirestore.instance
      .collection('labToLap')
      .doc('global')
      .collection('patients');
  ...
  Future<int> _getTotalForPatient(String patientId) async {
    final snap = await _patientsCol.doc(patientId).collection('lab_request').get();
    int total = 0;
  ...
  Future<void> _showDetailsDialog(String patientId, String patientName) async {
    final reqSnap = await _patientsCol.doc(patientId).collection('lab_request').get();
    int total = 0;
            ...
            return AlertDialog(
                        ...
                        onDateChanged: (d) {
                          setLocal(() {
                            ...
                            if (selectingStart) {
                              ...
                              selectingStart = false; // التالية ستكون للنهاية
                            } else {
              ...
              actions: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    setState(() {
                      _startDate = DateTime(tempStart.year, tempStart.month, tempStart.day);
