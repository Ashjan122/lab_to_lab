...
class ManageLabTestsScreen extends StatefulWidget {
  ...
  const ManageLabTestsScreen({super.key, required this.labId, required this.labName});
                ...
                builder: (context, snap) {
                  ...
                  final docs = snap.data!.docs.where((d) {
                    ...
                    ..sort((a, b) {
                      ...
                      if (hasOrderA && hasOrderB) return orderA.compareTo(orderB);
                  ...
                  if (docs.isEmpty) return const Center(child: Text('لا توجد فحوصات'));
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final hidden = data['hidden'] == true; // if missing we'll set to true below
                      if (!hasHiddenKey) {
                        WidgetsBinding.instance.addPostFrameCallback((_) async {
                          try {
                            await _col.doc(d.id).set({'hidden': true}, SetOptions(merge: true));
                          } catch (_) {}
                        });
                      }
                        ...
                        child: ListTile(
                          ...
                          trailing: Checkbox(
                            ...
                            onChanged: (v) async {
                              ...
                              try {
                                await _col.doc(d.id).set({'hidden': !nextChecked}, SetOptions(merge: true));
                                if (mounted) setState(() {});
                              } catch (e) {
                                if (context.mounted) {
